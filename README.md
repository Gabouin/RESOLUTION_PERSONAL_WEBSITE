...
| [`main.css`](./main.css) | Global styles and responsive layout |
| [`script.js`](./script.js) | UI interactions, modal logic, filters, and i18n behavior |
| [`images/`](./images) | Project assets and visuals |
